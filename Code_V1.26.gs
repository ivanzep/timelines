...
//  ───────────────
//  V1.26  2026-07-03
//    • SETTINGS_KEYS expanded with 3 settings that were collected by the HTML
//      but never written to the sheet:
//        todayLineColor       — Today-line color hex (default #ef4444)
//        metaDetailsCollapsed — whether the subtitle/date/note block is folded
//        statusColors         — JSON map of status → color (user-editable via popup)
//    • SETTINGS_DESCRIPTIONS updated for all 3 new keys.
//    • No other logic changes. Redeploy to activate settings persistence.
//
//  V1.25  2026-07-03
